...
public class ExerciseActivity extends AppCompatActivity {
    ...
    private RadioButton choice1RadioButton,choice2RadioButton,choise3RadioButton, choice4RadioButton;
    ...
    private void setupChoice() {
        ...
        choise3RadioButton.setText(strMyChoice[2]);
    ...
    public void clickAnswer(View view) {
        ...
        if (timeAnInt < 5) {
            questiontext.setText(strQuestion[timeAnInt]);
            trafficImage.setImageResource(intImage[timeAnInt]);
    ...
    private void bindWidget() {
        ...
        trafficImage = (ImageView) findViewById(R.id.imageView3);
        choiceRadioGroup = (RadioGroup) findViewById(R.id.radChoice);
        choice1RadioButton = (RadioButton) findViewById(R.id.radioButton);
        choice2RadioButton = (RadioButton) findViewById(R.id.radioButton2);
        choise3RadioButton = (RadioButton) findViewById(R.id.radioButton3);
